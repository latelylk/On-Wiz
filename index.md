...
`WizardGraphicalClient.exe` - The main executable for Wizard101. This can be coupled with the arguments I linked to earlier: [WGCArgs.md](https://github.com/ethankrein/On-Wiz/tree/master/Client/WGCArgs.md).
