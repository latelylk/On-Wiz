...
## As of now, all information below & all future information will be uploaded in wiki-format to <a href="https://ethankrein.github.io/On-Wiz/#!index.md" target="_blank">https://ethankrein.github.io/On-Wiz/</a>
...
`WizardGraphicalClient.exe` - The main executable for Wizard101. This can be coupled with the arguments I linked to earlier: [WGCArgs.md](Client/WGCArgs.md).
